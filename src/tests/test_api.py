...
class TestAPIGetTasks:
    ...
    def test_get_tasks_incorrect_api_key(self, mock_builds_and_tasks, build_name, api_key, url, test_client):
        with test_client:
    ...
    @pytest.mark.parametrize("build_name, api_key, url",
                             [("build1", "", "/get_tasks")])
    def test_get_tasks_no_api_key(self, mock_builds_and_tasks, build_name, api_key, url, test_client):
        with test_client:
            response = test_client.post(url=url,
                                        headers={"API-Key": api_key},
                                        json={"build": build_name})
    ...
    def test_get_tasks_success_response(self, mock_builds_and_tasks, build_name, url, expected_result, test_client):
        with test_client:
            response = test_client.post(url=url,
    ...
    def test_get_tasks_build_not_found(self, mock_builds_and_tasks, build_name, url, expected_result, test_client):
        with test_client:
            response = test_client.post(url=url,
                                        headers={"API-Key": os.getenv("API_KEY")},
                                        json={"build": build_name})
    ...
    def test_get_tasks_empty_build_name(self, mock_builds_and_tasks, build_name, url, expected_result, test_client):
        with test_client:
            response = test_client.post(url=url,
                                        headers={"API-Key": os.getenv("API_KEY")},
                                        json={"build": build_name})
    ...
    @pytest.mark.parametrize("build_name, url",
                             [(2, "/get_tasks")])
    def test_get_tasks_build_name_not_str(self, mock_builds_and_tasks, build_name, url, test_client):
        with test_client:
            response = test_client.post(url=url,
                                        headers={"API-Key": os.getenv("API_KEY")},
                                        json={"build": build_name})
